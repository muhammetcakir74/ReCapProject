...
namespace Core.Utilities.Helpers.FileHelper
{
    ...
    public class FileHeplerManager : IFileHelper
    {
        ...
        public string Upload(IFormFile file, string root)
        {
            ...
            {
                if (!Directory.Exists(root))//Directory=>System.IO'nın bir class'ı. burada ki işlem tam olarak şu. Bu Upload metodumun parametresi olan string root CarImageManager'dan gelmekte
